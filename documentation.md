...
| Blockchain records       | Read-only index (filters, sort, pagination) and show. **Admin + Security Operator only** (Guards forbidden). `show` includes related `jobs` and `verifications` when present. Demo seeding via `BlockchainRecordSeeder` is opt-in (`php artisan db:seed --class=BlockchainRecordSeeder`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
See also: [`../blockchain-module.md`](../blockchain-module.md), [`../blockchain-ethereum-v1/docs/m0-architecture-finalization-and-repository-split.md`](../blockchain-ethereum-v1/docs/m0-architecture-finalization-and-repository-split.md), [`../blockchain-ethereum-v1/docs/m1-ethereum-project-foundation.md`](../blockchain-ethereum-v1/docs/m1-ethereum-project-foundation.md), [`../blockchain-ethereum-v1/docs/m2-laravel-database-foundation.md`](../blockchain-ethereum-v1/docs/m2-laravel-database-foundation.md), [`../blockchain-ethereum-v1/docs/m3-configuration-and-environment-management.md`](../blockchain-ethereum-v1/docs/m3-configuration-and-environment-management.md), [`../blockchain-ethereum-v1/docs/m4-deterministic-hashing-architecture.md`](../blockchain-ethereum-v1/docs/m4-deterministic-hashing-architecture.md), [`../blockchain-ethereum-v1/docs/m5-blockchain-record-service-and-read-apis.md`](../blockchain-ethereum-v1/docs/m5-blockchain-record-service-and-read-apis.md), [`../blockchain-ethereum-v1/docs/m6-ganache-anchoring-end-to-end.md`](../blockchain-ethereum-v1/docs/m6-ganache-anchoring-end-to-end.md), and [`../blockchain-ethereum-v1/docs/m7-retry-and-failure-handling.md`](../blockchain-ethereum-v1/docs/m7-retry-and-failure-handling.md), and [`../blockchain-ethereum-v1/docs/m8-verification-system.md`](../blockchain-ethereum-v1/docs/m8-verification-system.md).
...
| GET       | `/api/auth/sessions`                                      | `AuthSessionController@index`             | —                        | List refresh sessions (own; Admin all/filter)                                                                                                                                                                                   | Optional: `user_id`, `per_page`                                                                                                                                                                         | Paginated session metadata; no `token_hash` (**M7**)                                                                                                                                                                                                                                                        |
...
| GET       | `/api/blockchain-records/summary`                         | `BlockchainRecordController@summary`      | Admin, Security Operator | Dashboard status counts, network/environment breakdown, latest failed records                                                                                     | —                                                                                                                                                                                                       | JSON: `success`, `message`, `data` (no RPC/private key fields)                                                                                                                                                                                                                                            |
| GET       | `/api/blockchain-records`                                 | `BlockchainRecordController@index`        | Admin, Security Operator | Paginated/filtered blockchain records                                                                                                                                                                                           | Inline query: `status`, `network`, `environment`, `entity_type`, `entity_id` (UUID), `search`, `sort_by`, `sort_order`, `per_page`                                                                      | `JsonResource` collection + pagination meta                                                                                                                                                                                                                                                               |
| GET       | `/api/blockchain-records/{blockchain_record}`             | `BlockchainRecordController@show`         | Admin, Security Operator | Single record with eager-loaded `jobs`, `verifications`, `verifications.verifiedBy`                                                                                                                                             | Implicit binding                                                                                                                                                                                        | `BlockchainRecordResource`                                                                                                                                                                                                                                                                                |
| POST      | `/api/blockchain-records/{blockchain_record}/verify`      | `BlockchainRecordController@verify`       | Admin, Security Operator | Run hash/on-chain verification; persists `blockchain_verifications` + verify job                                                                                                                                                | None                                                                                                                                                                                                    | `BlockchainVerificationResource` (**201**)                                                                                                                                                                                                                                                                |
...
| PUT/PATCH | `/api/users/{user}`                                       | `UserController@update`                   | `admin`                  | Update user (admin-only). Admin password updates set `last_password_changed_at` automatically; clients cannot write this field directly.                                                                                          | `UpdateUserRequest`                                                                                                                                                                                     | `UserResource`                                                                                                                                                                                                                                                                                            |
...
| GET       | `/api/anpr-events`                                        | `AnprEventController@index`               | —                        | List ANPR events with pagination and filters                                                                                                                                                                                    | Inline query: `per_page`, `page`, `plate_number`, `search`, `is_valid`, `is_flagged`, `date_from`, `date_to`, `camera_id`, `sort`, `direction`, `since` (M12 live polling)                              | `{ success, message, data }` — paginated `AnprEventResource` collection inside `data`; default sort `detection_time` desc; `since` filters `created_at > since` OR `detection_time > since`                                                                                                               |
| POST      | `/api/anpr-events`                                        | `AnprEventController@store`               | —                        | Create ANPR event                                                                                                                                                                                                               | Inline validation (`camera_id`, `plate_number`, `confidence`, `detection_time`, `is_valid`, `latitude`, `longitude`; `blockchain_record_id` **prohibited**; **M10** auto blockchain proof when enabled) | `{ success, message, data }` — `AnprEventResource` (**201**)                                                                                                                                                                                                                                              |
...
| DELETE    | `/api/anpr-events/{anpr_event}`                           | `AnprEventController@destroy`             | —                        | Permanent delete ANPR event row                                                                                                                                                                                                 | —                                                                                                                                                                                                       | **204** empty body; **409** when event has `entity_created` proof or any child image has `evidence_file` proof                                                                                                                                                                                            |
| POST      | `/api/anpr-events/{anpr_event}/images/upload`             | `AnprImageController@uploadForEvent`      | —                        | Upload evidence image for an ANPR event (multipart: `image_type`, `image`)                                                                                                                                                      | Inline validation (`image_type`, `image` file)                                                                                                                                                          | `{ success, message, data }` — `AnprImageResource`; stores under `storage/app/anpr`; idempotent replace by event + type (**200**) when no matching row has an `evidence_file` proof; **409** when any matching row is proofed (no file/row change)                                                        |
...
| PUT/PATCH | `/api/anpr-images/{anpr_image}`                           | `AnprImageController@update`              | —                        | Update ANPR image metadata                                                                                                                                                                                                      | Inline validation (same fields as create; `sometimes` for patch semantics)                                                                                                                              | `{ success, message, data }` — `AnprImageResource`; **409** when changing canonical proof fields on a proofed image (`anpr_event_id`, `image_type`, `file_path`, `file_size`, `resolution`)                                                                                                               |
| DELETE    | `/api/anpr-images/{anpr_image}`                           | `AnprImageController@destroy`             | —                        | Permanent delete ANPR image row                                                                                                                                                                                                 | —                                                                                                                                                                                                       | **204** empty body; **409** when an `evidence_file` blockchain proof exists                                                                                                                                                                                                                               |
...
| `users`                    | `id` UUID   | `role_id` FK → `roles` (nullable, null on delete); **`setup_required`** boolean default `false`; **`last_password_changed_at`**; **soft deletes** |
| `password_setup_tokens`    | `id` UUID   | **M4:** FK `user_id` → `users` (cascade); indexed `token_hash` (SHA-256); `expires_at`; nullable `used_at`; single-use first-login setup tokens |
...
| ANPR events              | CRUD ANPR detections via API under `auth:api`; requires valid `camera_id`; supports nullable `vehicle_id`; `blockchain_record_id` is backend-managed and must not be sent by clients; validates confidence/time/coordinates; permanent delete via `delete()`                              |
...
| `JWT_SECRET`, `JWT_TTL`                 | JWT signing and default TTL (overridden on login/refresh by `AUTH_ACCESS_TOKEN_TTL`)                         |
| `AUTH_ACCESS_TOKEN_TTL`, `AUTH_REFRESH_TOKEN_TTL_HOURS`, `AUTH_REFRESH_COOKIE_*` | Login Module M1 refresh sessions (`config/auth_security.php`); set `AUTH_REFRESH_COOKIE_SECURE=true` on HTTPS |
| `CORS_ALLOWED_ORIGINS` | Comma-separated React origins for credentialed API requests (`config/cors.php`; required for cross-origin HttpOnly refresh cookies) |
...
| `AuthPasswordSetupTest.php`     | **M4:** Setup-required login branch; admin create; token expiry/reuse; password completion; post-setup login; no refresh cookie for setup-required login |
| `AuthRateLimitLockoutTest.php`  | **M6:** Login rate limit/lockout; audit rows; OTP lockout; soft-deleted user login/refresh/me; session revoke on disable |
| `AuthAuditLogTest.php`          | **M7:** Audit event coverage; metadata sanitization; Admin audit API + filters |
| `AuthSessionMonitoringTest.php` | **M7:** Session list/revoke/logout-all; no token hash exposure; authorization |
...
| `Auth/PasswordSetupServiceTest.php`   | **M4:** Setup token hash storage, invalidation, expiry, reuse, completion |
